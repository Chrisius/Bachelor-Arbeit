...
Native \mnote{Native visualization} visualization describes creating of visual ascertainable objects only by means of resources that a specific system provides without any addition.\\
